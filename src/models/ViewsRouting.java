...
import controllers.AdminAvailableTicketController;
import controllers.AdminManageProfileController;
import controllers.AdminPageController;
import controllers.CustomerAvailableTicketController;
import controllers.CustomerBookingController;
...
public class ViewsRouting {
	...
	public void handleRoutingAdminAvailableTicket(String viewName, Pane paneName, String username, String password,
			String title) {
		...
		AdminAvailableTicketController adminAvailableTicketCtrl = (AdminAvailableTicketController) loader.getController();
		adminAvailableTicketCtrl.initData(username, password);
	...
	public void handleRoutingViewBookings(String viewName, Pane paneName, String username, String password,
			String title) {
		...
		CustomerBookingController viewbookings = (CustomerBookingController) loader.getController();
		viewbookings.initData(username, password);
	...
	public void handleRoutingCustomerAvailableTicket(String viewName, Pane paneName, String username, String password,
			String title) {
		...
		CustomerAvailableTicketController customerAvailableRoomController = (CustomerAvailableTicketController) loader.getController();
