...
public class CustomerLoginController {
	...
	viewr.handleRouting("/views/CustomerRegisterView.fxml", customer_view_pane,"TICKETMASTER");
	}
	...
	public void checkCredentials(String username, String password) {
		...
		try {
			viewr.handleRoutingCustomerPage("/views/CustomerPageView.fxml", customer_view_pane, username, password, "TICKETMASTER");	
	...
	public void onCustomerBack() {
		viewr.handleRouting("/views/HomescreenView.fxml", customer_view_pane, "TICKETMASTER");
